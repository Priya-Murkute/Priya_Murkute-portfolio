...
function hasTransition(variant: unknown): variant is { transition: Transition } {
...
export function TextEffect({
  ...
  const containerBase = variants?.container ?? baseVariants.container;
  const containerVisible = containerBase.visible;
  ...
  const computedVariants = {
    container: createVariantsWithTransition(containerBase, {
      staggerChildren: customStagger ?? stagger,
      delayChildren: typeof customDelay === "number" ? customDelay : delay,
      ...containerTransition,
