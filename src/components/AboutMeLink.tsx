 ...
 */
export default function AboutMeLink({ className }: { className?: string }) {
  return (
    <Link
      to="/about-me"
      className={cn(
        "pill-sheen group relative inline-flex items-center gap-2.5 overflow-hidden rounded-full border border-line bg-surface/70 py-1.5 pl-4 pr-1.5 font-mono text-[0.6875rem] uppercase tracking-[0.14em] text-muted backdrop-blur transition-colors hover:border-line-strong hover:text-ink",
        className,
      )}
    >
